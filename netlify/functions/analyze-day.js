...
exports.handler = async function (event) {
  ...
  const promptParts = [
    ...
    "2. האם צריכת החלבון וסיבים תזונתיים מספיקה ביחס ליעד",
    "3. האם יש חוסר איזון בין המאקרו-נוטריאנטים (למשל עודף שומן, מעט מדי פחמימה)",
    "4. המלצה מעשית אחת או שתיים להמשך היום (למשל 'כדאי להוסיף מקור פחמימה מורכבת', 'תוסיף מנת חלבון או ירקות עשירים בסיבים')",
    ...
    `- סיבים תזונתיים: ${Math.round(t.fi||0)}g מתוך יעד ${g.fiberGoal ?? "לא ידוע"}g`,
  ].join("\n");
